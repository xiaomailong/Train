...
package body Switch is
   ...
   procedure Set (This : in out Object; Switch_Position : Position) is
   begin
      This.Is_Set           := True;
      This.Current_Position := Switch_Position;
   end Set;

   function Is_Set (This : in Object) return Boolean is
   begin
      return This.Is_Set;
   end Is_Set;
   ...
   function Connexion (This : Object) return Link is
   begin
      if This.Is_Set
      then
